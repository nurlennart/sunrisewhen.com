...
navigator.geolocation.getCurrentPosition(savePosition, guesstimated);
...
function updateDivs(times, position) {
    ...
    document.getElementById("twilight_begin").innerHTML = 'TWILIGHT ' + times["CivilTwilightBegin"];
    document.getElementById("twilight_end").innerHTML = 'TWILIGHT ' + times["CivilTwilightEnd"];
